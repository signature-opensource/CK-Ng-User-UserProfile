...
describe( 'AppComponent', () => {
  ...
  it( `should have the 'CK_Ng_UserProfile_Workspace' title`, () => {
    const fixture = TestBed.createComponent( AppComponent );
    const app = fixture.componentInstance;
    expect( app.title ).toEqual( 'CK_Ng_UserProfile_Workspace' );
  } );
  ...
  it( 'should render title', () => {
    ...
    expect( compiled.querySelector( 'h1' )?.textContent ).toContain( 'Hello, CK_Ng_UserProfile_Workspace' );
  } );
} );
