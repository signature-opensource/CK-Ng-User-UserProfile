...
import { BasicLoginForm } from '../Basic/basic-login-form/basic-login-form';
import { ResponsiveDirective } from '@local/ck-gen/CK/Ng/Zorro/responsive.directive';

@Component({
    selector: 'ck-login',
    imports: [
        CommonModule,
        TranslateModule, BasicLoginForm,
        ResponsiveDirective,
        NzButtonModule
    ],
